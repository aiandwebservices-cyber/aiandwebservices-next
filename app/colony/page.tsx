...
export default function Page() {
  ...
  const STAT_CARDS = [
    ...
    { label: 'HOT LEADS',        value: stats.hot,         color: '#E11D48', prefix: '',  suffix: '',  subtitle: stats.hot > 0 ? `respond now · ${hotRate}% of active` : 'all clear ✓' },
    { label: 'REPLIES TODAY',    value: stats.replies,     color: '#60a5fa', prefix: '',  suffix: '',  subtitle: replyRate !== null ? `${replyRate}% reply rate` : 'inbound signals' },
      ...
      <div style={{ position: 'relative', height: 'calc(100vh - 56px)', overflow: 'hidden', background: '#080d18' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, height: '100%', overflowY: 'auto', scrollbarWidth: 'thin' }}>
          <main style={{
            ...
            {/* ── Stats stripe ─────────────────────────────────────── */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 10, maxWidth: 1400, margin: '0 auto', width: '100%' }}>
