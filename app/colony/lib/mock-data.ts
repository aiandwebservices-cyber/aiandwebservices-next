...
function makeBots(cohortId: Cohort): Bot[] {
  return [
    ...
    { id: `bot-${cohortId}-bob`, cohort_id: cohortId, name: 'Bob — Case Study Writer', role: 'Case Study Writer', avatar_emoji: '📝', last_run_at: '2026-04-24T07:30:00Z', last_output_summary: 'Watches the pipeline, writes case studies, prevents self-contradiction across drafts', decisions_this_week: 18 },
...
const DEMO_FEED: FeedEvent[] = [
  ...
  { id: 'feed-d04', cohort_id: 'demo', timestamp: '2026-04-24T06:00:00Z', type: 'bot_run', title: 'Bob generated 3 case study drafts', subtitle: 'Pipeline snapshot captured · Qdrant updated', icon: '📝', drill_target: { type: 'bot', id: 'bot-demo-bob' } },
