...
export type FeedEventType = 'bot_run' | 'lead_new' | 'lead_hot' | 'pipeline_move' | 'revenue' | 'bill_nye_finding' | 'coach_alert' | 'reply_received' | 'reply_interested' | 'payment_received' | 'payment_failed' | 'payment_refunded' | 'email_sent'
