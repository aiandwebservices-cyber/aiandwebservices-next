  ...
  return (
    <div style={{ fontFamily: "'Barlow','Helvetica Neue',sans-serif", background: BLACK, color: OFF, overflowX: 'hidden' }}>
      {isPreview && <style>{`
        ...
        .hero-gallery{width:220px !important}
      ...
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .hero-btns{display:flex;gap:1rem;flex-wrap:wrap;justify-content:center;margin:0 auto;transition:opacity 1.1s .75s,transform 1.1s .75s cubic-bezier(.16,1,.3,1)}
