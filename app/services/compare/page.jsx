...
export default function CompareAllPlansPage() {
  ...
  return (
    <>
      ...
      {/* TWO TRACKS */}
      <section style={{ padding: 'clamp(56px,8vw,88px) 20px', background: '#ffffff', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
      ...
      {/* CTA */}
      <section style={{ padding: 'clamp(72px,10vw,110px) 20px', background: '#f8fafc' }}>
        <FadeUp>
      ...
      {/* Add-ons note */}
      <div style={{ background: '#ffffff', borderTop: '1px solid rgba(0,0,0,0.06)', padding: '20px', textAlign: 'center' }}>
