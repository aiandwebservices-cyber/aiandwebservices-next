...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Enhance any tier with crypto payment infrastructure, e-commerce integration, or WCAG accessibility compliance.',
    url: 'https://www.aiandwebservices.com/services/add-ons',
    type: 'website',
  },
};
  ...
  '@graph': [
    {
      ...
      description: 'Accept Bitcoin, stablecoins, and multi-chain payments on your website.',
      provider: { '@type': 'Organization', name: 'AIandWEBservices', url: 'https://www.aiandwebservices.com' },
      offers: { '@type': 'Offer', price: '997', priceCurrency: 'USD', name: 'One-time setup' },
    },
    {
      '@type': 'Service',
      name: 'E-commerce Integration',
      description: 'Shopify or WooCommerce store built and connected to your existing site and AI systems.',
      provider: { '@type': 'Organization', name: 'AIandWEBservices', url: 'https://www.aiandwebservices.com' },
      offers: { '@type': 'Offer', price: '1497', priceCurrency: 'USD', name: 'Starting price' },
    },
    {
      '@type': 'Service',
      name: 'Accessibility Audit (WCAG)',
      description: 'Full WCAG 2.1 AA compliance audit and remediation report.',
      provider: { '@type': 'Organization', name: 'AIandWEBservices', url: 'https://www.aiandwebservices.com' },
      offers: { '@type': 'Offer', price: '497', priceCurrency: 'USD', name: 'One-time audit' },
    },
    {
      '@type': 'BreadcrumbList',
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Add-On Services', item: 'https://www.aiandwebservices.com/services/add-ons' },
      ],
    },
  ],
};
      ...
      <div className="svc-page-wrap">
        ...
        <section className="svc-page-section">
          <div className="svc-addon-list">
            {ADDONS.map(({ Icon, iconColor, name, price, perfectFor, desc, includes }, i) => (
              <div key={i} className="svc-addon-block">
                <div className="svc-addon-header">
                  ...
                  <div>
                    ...
                    <div className="svc-addon-price">{price}</div>
                  </div>
                </div>
