...
export default function CrispChat() {
  useEffect(() => {
    function initCrisp() {
      ...
      window.removeEventListener('pointerdown', initCrisp);
    ...
    window.addEventListener('scroll', initCrisp, { once: true });
    window.addEventListener('pointerdown', initCrisp, { once: true });
  }, []);
