    ...
    <section className="panel" id="p0" aria-label="AIandWEBservices — AI automation, web development and SEO for small business">
      ...
      <style>{`
        ...
        @media (max-width:768px) {
          ...
          .h-h1 { font-size:clamp(42px,9.5vw,54px);letter-spacing:-0.5px;overflow-wrap:break-word;hyphens:auto; }
        }
        @media (max-width:480px) {
          .h-eyebrow { font-size:10px;padding:6px 14px; }
          .h-h1 { font-size:clamp(32px,8.5vw,42px);letter-spacing:-0.5px;overflow-wrap:break-word;hyphens:auto; }
