    ...
    <section className="panel" id="p0" aria-label="AIandWEBservices — AI automation, web development and SEO for small business">
      ...
      <style>{`
        ...
        @media (max-width:768px) {
          ...
          .h-h1 { font-size:clamp(48px,8vw,60px);letter-spacing:-0.5px;overflow-wrap:break-word;hyphens:auto; }
        ...
        @media (max-width:480px) {
          ...
          .h-h1 { font-size:clamp(40px,7.5vw,50px);letter-spacing:-0.5px;overflow-wrap:break-word;hyphens:auto; }
