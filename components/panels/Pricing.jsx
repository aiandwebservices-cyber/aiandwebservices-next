...
const MAIN_PLANS = [
  { Icon: Sprout, iconColor:'#34d399', name:'Presence', tagline:'Get found online', price:'99', setup:'$299', features:['Professional website (5 pages)','Local SEO + Google Business Profile','Basic AI inquiry assistant','Monthly performance report'], best:'Brand new businesses that need a professional foundation', serviceAnchor:'#service-presence', pricingId:'pricing-presence' },
  { Icon: TrendingUp, iconColor:'#34d399', name:'Growth', tagline:'Turn visitors into leads', price:'199', setup:'$799', features:['Everything in Presence','AI automation & smart assistant','Email marketing + welcome sequence','SEO content (2 articles/month)','Conversion-optimized landing page'], best:'Established businesses ready to generate consistent leads', serviceAnchor:'#service-growth', pricingId:'pricing-growth' },
  ...
  { Icon: Brain, iconColor:'#60a5fa', name:'AI-First', tagline:'Replace manual work with AI', price:'499', setup:'$1,799', features:['Everything in Revenue Engine','Advanced AI automation pipelines','Voice AI (answering + booking)','Programmatic SEO at scale','Social media AI scheduling','Full analytics dashboard'], best:'Owners who want to run a bigger business with the same size team', serviceAnchor:'#service-ai-first', pricingId:'pricing-ai-first' },
