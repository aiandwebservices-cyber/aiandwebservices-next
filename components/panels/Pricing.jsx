...
const MAIN_PLANS = [
  { Icon: Sprout, iconColor:'#34d399', name:'Presence', tagline:'Get found online', price:'297', setup:'$997', features:['Professional website (5 pages)','Local SEO + Google Business Profile','Basic AI inquiry assistant','Monthly performance report'], best:'Brand new businesses that need a professional foundation', serviceAnchor:'#service-presence', pricingId:'pricing-presence' },
  ...
  { Icon: Zap, iconColor:'#a78bfa', name:'Revenue Engine', tagline:'Automate your sales process', price:'997', setup:'$3,997', popular:true, features:['Everything in Growth','Full sales funnel design & build','Workflow automation & integration','Paid ads setup (Google or Meta)','AI-powered CRM integration','Monthly strategy call with David'], best:'Businesses serious about scaling revenue without scaling headcount', serviceAnchor:'#service-revenue-engine', pricingId:'pricing-revenue-engine' },
  { Icon: Brain, iconColor:'#60a5fa', name:'AI-First', tagline:'Replace manual work with AI', price:'1,497', setup:'$5,497', features:['Everything in Revenue Engine','Advanced AI automation pipelines','Voice AI (answering + booking)','Programmatic SEO at scale','Social media AI scheduling','Full analytics dashboard'], best:'Owners who want to run a bigger business with the same size team', serviceAnchor:'#service-ai-first', pricingId:'pricing-ai-first' },
