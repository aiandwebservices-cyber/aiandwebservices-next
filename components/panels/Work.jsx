    ...
    <section className="panel" id="samples" aria-label="Sample websites built by AIandWEBservices">
      ...
      <div className="work-inner">
        <div style={{ position:'relative', zIndex:1, display:'flex', flexDirection:'column', height:'100%' }}>
          ...
          <motion.div {...f(0.14)} className="wk-browser" style={{ flex:1, minHeight:0, maxHeight:'calc(53vh + 100px)' }}>
            {/* Chrome bar */}
      ...
      <style>{`
        ...
        .work-inner .panel-cta-wrap { margin-top:auto;padding-top:60px;padding-bottom:clamp(16px,2.5vh,28px); }
