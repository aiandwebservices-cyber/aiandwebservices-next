...
const MAIN_PLANS = [
  { Icon: Sprout, iconColor:'#34d399', name:'Presence', tagline:'Get found online', price:'99', setup:'$299', features:['Professional website (5 pages)','Local SEO + Google Business Profile','Basic AI inquiry assistant','Monthly performance report'], best:'Brand new businesses that need a professional foundation', serviceHref:'/services/presence', pricingId:'pricing-presence' },
  { Icon: TrendingUp, iconColor:'#34d399', name:'Growth', tagline:'Turn visitors into leads', price:'199', setup:'$799', features:['Everything in Presence','AI automation & smart assistant','Email marketing + welcome sequence','SEO content (2 articles/month)','Conversion-optimized landing page'], best:'Established businesses ready to generate consistent leads', serviceHref:'/services/growth', pricingId:'pricing-growth' },
  { Icon: Zap, iconColor:'#a78bfa', name:'Revenue Engine', tagline:'Automate your sales process', price:'299', setup:'$1,199', popular:true, features:['Everything in Growth','Full sales funnel design & build','Workflow automation & integration','Paid ads setup (Google or Meta)','AI-powered CRM integration','Monthly strategy call with David'], best:'Businesses serious about scaling revenue without scaling headcount', serviceHref:'/services/revenue-engine', pricingId:'pricing-revenue-engine' },
  { Icon: Brain, iconColor:'#60a5fa', name:'AI-First', tagline:'Replace manual work with AI', price:'499', setup:'$1,799', features:['Everything in Revenue Engine','Advanced AI automation pipelines','Voice AI (answering + booking)','Programmatic SEO at scale','Social media AI scheduling','Full analytics dashboard'], best:'Owners who want to run a bigger business with the same size team', serviceHref:'/services/ai-first', pricingId:'pricing-ai-first' },
  { Icon: Target, iconColor:'#f87171', name:'Consulting', tagline:'Know exactly where to start', price:'99', priceLabel:' once', setup:'or $399/mo fractional', features:['AI readiness audit','Digital transformation roadmap','Tool stack recommendations','Staff AI training & workshops','Fractional AI advisor (ongoing)'], best:'Businesses that want expert guidance before committing to a full build', serviceHref:'/services/consulting', pricingId:'pricing-consulting', consultingLink:'/services/consulting' },
];
