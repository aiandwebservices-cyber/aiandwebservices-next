...
export default function ContactExperience({ standalone = false }) {
  ...
  return (
    <div style={{
      ...
      margin: '0 auto',
      padding: standalone
        ? 'clamp(80px, 9vw, 110px) 6vw clamp(20px, 3vw, 44px)'
        : 'clamp(24px, 4vw, 48px) 6vw clamp(20px, 3vw, 36px)',
      display: 'flex',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <motion.div {...fade(0)} style={{ maxWidth: '700px', margin: '0 auto clamp(12px, 2vw, 20px)', textAlign: 'center' }}>
          ...
          <Heading style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 'clamp(22px, 3.8vw, 46px)', fontWeight: 800, letterSpacing: '-1px', lineHeight: 1.1, color: '#fff', marginBottom: 10 }}>
