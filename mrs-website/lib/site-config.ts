  ...
  services: [
    {
      ...
      title: 'Water Damage Restoration',
      cardDesc: 'Rapid extraction, drying & dehumidification 24/7.',
      desc: "Frozen pipes, burst pipes, appliance leaks, roof leaks — water damage gets worse every hour. Our IICRC-certified technicians extract standing water, deploy industrial drying equipment, and monitor moisture levels until your NYC property is fully dry.",
    ...
    },
    {
      ...
      title: 'Fire & Smoke Damage Restoration',
      cardDesc: 'Full fire & smoke damage cleanup and deodorization.',
      desc: 'Fire destroys structure; smoke and soot destroy everything else. We handle emergency board-up, complete smoke odor elimination, soot removal, and full structural restoration — including NYC multi-unit buildings.',
    ...
    },
    {
      ...
      desc: "NYC's aging housing stock and humid summers make mold a year-round concern. We test, identify, contain, and eliminate mold following EPA and IICRC protocols, then address the moisture source to prevent recurrence.",
    ...
    },
    {
      ...
      desc: "Nor'easters can strike October through April, and summer thunderstorms bring flash flooding to all five boroughs. We respond immediately after storm events with emergency tarping, board-up, water extraction, and full structural repairs.",
    ...
    },
    {
      ...
      title: 'Sewage & Biohazard Cleanup',
      cardDesc: 'Safe sewage & biohazard remediation.',
      desc: 'Sewage backups and biohazard situations require specialized protective equipment and disposal protocols. We handle it safely, discreetly, and thoroughly — including NYC apartment buildings and commercial properties.',
    ...
    },
    {
      ...
      title: 'Reconstruction & Rebuild',
      cardDesc: 'Full rebuild and restoration after damage.',
      desc: 'After mitigation is complete, we handle the full rebuild — from drywall and flooring to complete structural reconstruction. One contractor for the entire job, including NYC co-ops, condos, and multi-unit buildings.',
