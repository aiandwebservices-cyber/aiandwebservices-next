...
export function useHorizontalScroll() {
  ...
  useEffect(() => {
    ...
    const TOTAL = 8;
    const hashNames = ['home','how-it-works','comparison','services','about','faq','blog','contact'];
    ...
    function updateUI(push = false) {
      ...
      // Maps nav pill index → panel index. 8 nav items (0-7), all visible.
    ...
    // Order: Home(0), HowItWorks(1), Comparison(2), Services(3), About(4), FAQ(5), Blog(6), Contact(7)
    const panelIds = ['p0','p2','comparison','services','p3','p7','p6','p8'];
